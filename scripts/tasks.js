...
window.addEventListener('load', function () {
  ...
  btnCerrarSesion.addEventListener('click', function () {
    ...
    const confirma = confirm('Seguro que deseas salir?')
  ...
  function obtenerNombreUsuario() {
    ...
    const usuarioLogueado = document.getElementById('nombre_usuario');
    ...
    fetch(URL, requestConfig).then(res => { return res.json() })
      .then(data => {
        const { firstName, lastName } = data;
        usuarioLogueado.textContent = firstName + ' ' + lastName;
      })
  ...
  function renderizarTareasWeb(listado) {
